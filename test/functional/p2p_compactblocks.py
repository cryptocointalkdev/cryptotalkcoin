#!/usr/bin/env python3
# Copyright (c) 2016-2019 The Cryptotalkcoin Core developers
...
# TestP2PConn: A peer we use to send messages to cryptotalkcoind, and store responses.
...
class CompactBlocksTest(CryptotalkcoinTestFramework):
    ...
    # This test actually causes cryptotalkcoind to (reasonably!) disconnect us, so do this last.
    ...
    # cryptotalkcoind's choice of nonce.
    ...
    # Test that cryptotalkcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for cryptotalkcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # cryptotalkcoind will not send blocktxn responses for blocks whose height is
