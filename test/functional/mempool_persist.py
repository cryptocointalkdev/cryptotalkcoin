...
By default, cryptotalkcoind will dump mempool on shutdown and
...
class MempoolPersistTest(CryptotalkcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent cryptotalkcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
