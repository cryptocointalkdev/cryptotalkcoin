...
class InvalidMessagesTest(CryptotalkcoinTestFramework):
    ...
    def run_test(self):
        ...
        if [s for s in os.environ.get("CRYPTOTALKCOIN_CONFIG", "").split(" ") if "--with-sanitizers" in s and "address" in s]:
