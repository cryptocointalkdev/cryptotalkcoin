...
"""Verify that starting cryptotalkcoin with -h works as expected."""

from test_framework.test_framework import CryptotalkcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(CryptotalkcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start cryptotalkcoin with -h for help text")
        ...
        self.log.info("Start cryptotalkcoin with -version for version information")
        ...
        self.log.info("Start cryptotalkcoind with -fakearg to make sure it does not start")
