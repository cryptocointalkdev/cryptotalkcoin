...
class AvoidReuseTest(CryptotalkcoinTestFramework):
    ...
    def test_fund_send_fund_senddirty(self):
        '''
        Test the same as test_fund_send_fund_send, except send the 10 CRT with
        the avoid_reuse flag set to false. This means the 10 CRT send should succeed,
    ...
    def test_fund_send_fund_send(self):
        ...
        [0] sends 10 CRT to A.
        [1] spends 5 CRT from A. (leaving roughly 5 CRT useable)
        [0] sends 10 CRT to A again.
        [1] tries to spend 10 CRT (fails; dirty).
        [1] tries to spend 4 CRT (succeeds; change address sufficient)
        '''
