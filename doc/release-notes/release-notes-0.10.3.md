Cryptotalkcoin Core version 0.10.3 is now available from:

  <https://cryptotalkcoin.org/bin/cryptotalkcoin-core-0.10.3/>
...
(see https://github.com/cryptotalkcoin/cryptotalkcoin/pull/6793, as well as the 0.11.0
