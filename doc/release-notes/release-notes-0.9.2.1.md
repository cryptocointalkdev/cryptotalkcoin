Cryptotalkcoin Core version 0.9.2.1 is now available from:

  https://cryptotalkcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 CRT to 0.01 CRT
...
- Fix "Start cryptotalkcoin on system login"
