Download URL: https://sourceforge.net/projects/cryptotalkcoin/files/Cryptotalkcoin/cryptotalkcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 CRT fee schedule (users still pay 0.01 CRT per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #cryptotalkcoin00 - #cryptotalkcoin99
