Cryptotalkcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/cryptotalkcoin/files/Cryptotalkcoin/cryptotalkcoin-0.5.4/
...
http://gitorious.org/cryptotalkcoin/cryptotalkcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Cryptotalkcoin-Qt notifications under Growl 1.3.
Increase required age of Cryptotalkcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCryptotalkcoin properly when installing Cryptotalkcoin-Qt over it. (Windows)
