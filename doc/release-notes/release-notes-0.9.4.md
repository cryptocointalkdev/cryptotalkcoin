Cryptotalkcoin Core version 0.9.4 is now available from:

  https://cryptotalkcoin.org/bin/0.9.4/
...
this update is incompatible with the Cryptotalkcoin system and could lead to consensus
forks.

Cryptotalkcoin Core released binaries from https://cryptotalkcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~cryptotalkcoin/+archive/ubuntu/cryptotalkcoin
- A third-party or self-compiled Cryptotalkcoin Core

upgrade to Cryptotalkcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
