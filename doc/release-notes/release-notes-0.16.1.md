Cryptotalkcoin Core version 0.16.1 is now available from:

  <https://cryptotalkcoincore.org/bin/cryptotalkcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting cryptotalkcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure cryptotalkcoind processes are cleaned up when tests end (sdaftuar)
