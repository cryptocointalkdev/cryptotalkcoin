Cryptotalkcoin Core version 0.13.2 is now available from:

  <https://cryptotalkcoin.org/bin/cryptotalkcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update cryptotalkcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow cryptotalkcoin-tx to create v2 transactions (btcdrak)
