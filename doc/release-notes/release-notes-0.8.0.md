Cryptotalkcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/cryptotalkcoin/files/Cryptotalkcoin/cryptotalkcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Cryptotalkcoin
...
New/changed settings (command-line or cryptotalkcoin.conf file)
--------------------------------------------------------
