Cryptotalkcoin Core version 0.10.4 is now available from:

  <https://cryptotalkcoin.org/bin/cryptotalkcoin-core-0.10.4/>
...
- #6953 `43c2789` Split cryptotalkcoin-tx into its own package
- #6953 `dfe0d4d` Include cryptotalkcoin-tx binary on Debian/Ubuntu
