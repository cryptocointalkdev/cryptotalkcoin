Cryptotalkcoin Core version *0.14.3* is now available from:

  <https://cryptotalkcoin.org/bin/cryptotalkcoin-core-0.14.3/>
...
- #10451 `3612219` contrib/init/cryptotalkcoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
