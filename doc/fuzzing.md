Fuzz-testing Cryptotalkcoin Core
==========================
...
```
git clone https://github.com/cryptotalkcoin-core/qa-assets
...
To build Cryptotalkcoin Core using AFL instrumentation (this assumes that the
