...
This document provides guidelines for internationalization of the Cryptotalkcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `cryptotalkcoin_en.ts` remains unchanged.
