...
```sh
make src/cryptotalkcoind src/cryptotalkcoin-cli
make src/qt/cryptotalkcoin-qt
make -C src cryptotalkcoin_bench
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:cryptotalkcoin/cryptotalkcoin.git
```
