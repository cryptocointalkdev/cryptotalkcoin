...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the cryptotalkcoin repository."
  exit 1
fi
...
# See https://github.com/cryptotalkcoin/cryptotalkcoin/issues/16064
...
echo
echo 'When compiling cryptotalkcoind, run `./configure` in the following way:'
echo
