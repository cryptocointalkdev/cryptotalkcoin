...
static void SetupCryptotalkcoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " cryptotalkcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  cryptotalkcoin-tx [options] <hex-tx> [commands]  Update hex-encoded cryptotalkcoin transaction\n" +
            "or:     cryptotalkcoin-tx [options] -create [commands]   Create hex-encoded cryptotalkcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cryptotalkcoin transaction
