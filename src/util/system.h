 ...
 */
#ifndef CRYPTOTALKCOIN_UTIL_SYSTEM_H
#define CRYPTOTALKCOIN_UTIL_SYSTEM_H
...
extern const char * const CRYPTOTALKCOIN_CONF_FILENAME;
...
#endif // CRYPTOTALKCOIN_UTIL_SYSTEM_H
