...
#ifndef CRYPTOTALKCOIN_PSBT_H
#define CRYPTOTALKCOIN_PSBT_H
...
struct PartiallySignedTransaction
{
    ...
    /** Merge psbt into this. The two psbts must have the same underlying CTransaction (i.e. the
      * same actual Cryptotalkcoin transaction.) Returns true if the merge succeeded, false otherwise. */
