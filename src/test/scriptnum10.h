...
#ifndef CRYPTOTALKCOIN_TEST_SCRIPTNUM10_H
#define CRYPTOTALKCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Cryptotalkcoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // CRYPTOTALKCOIN_TEST_BIGNUM_H
