// Copyright (c) 2012-2019 The Cryptotalkcoin Core developers
...
{
    BOOST_CHECK(TestSplitHost("www.cryptotalkcoincore.org", "www.cryptotalkcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.cryptotalkcoincore.org]", "www.cryptotalkcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.cryptotalkcoincore.org:80", "www.cryptotalkcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.cryptotalkcoincore.org]:80", "www.cryptotalkcoincore.org", 80));
