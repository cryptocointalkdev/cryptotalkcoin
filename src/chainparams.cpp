...
public:
    CMainParams() {
        ...
        checkpointData = {
            {
                { 0, uint256S("0x00000a9661c4609573f74d530d3acbc6493ab237b5c201c9417c91a6cc493a4f")},
            }
        };
...
public:
    CTestNetParams() {
       ...
       // assert(genesis.hashMerkleRoot == uint256S("0x4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"));
        ...
        vSeeds.emplace_back("testnet-seed.cryptotalkcoin.jonasschnelli.ch");
        vSeeds.emplace_back("seed.tbtc.petertodd.org");
        vSeeds.emplace_back("seed.testnet.cryptotalkcoin.sprovoost.nl");
