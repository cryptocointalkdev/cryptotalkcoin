...
#ifndef CRYPTOTALKCOIN_INTERFACES_NODE_H
#define CRYPTOTALKCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a cryptotalkcoin node (cryptotalkcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // CRYPTOTALKCOIN_INTERFACES_NODE_H
