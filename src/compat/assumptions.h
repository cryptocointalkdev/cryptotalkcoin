...
#ifndef CRYPTOTALKCOIN_COMPAT_ASSUMPTIONS_H
#define CRYPTOTALKCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Cryptotalkcoin cannot be compiled without assertions."
#endif
...
#endif // CRYPTOTALKCOIN_COMPAT_ASSUMPTIONS_H
