...
#ifndef CRYPTOTALKCOIN_QT_SPLASHSCREEN_H
#define CRYPTOTALKCOIN_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Cryptotalkcoin Core initialization
...
#endif // CRYPTOTALKCOIN_QT_SPLASHSCREEN_H
