...
#ifndef CRYPTOTALKCOIN_QT_CRYPTOTALKCOINUNITS_H
#define CRYPTOTALKCOIN_QT_CRYPTOTALKCOINUNITS_H
...
/** Cryptotalkcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class CryptotalkcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit CryptotalkcoinUnits(QObject *parent);

    /** Cryptotalkcoin units.
      @note Source: https://en.cryptotalkcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        CRT,
...
typedef CryptotalkcoinUnits::Unit CryptotalkcoinUnit;

#endif // CRYPTOTALKCOIN_QT_CRYPTOTALKCOINUNITS_H
