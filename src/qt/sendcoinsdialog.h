...
#ifndef CRYPTOTALKCOIN_QT_SENDCOINSDIALOG_H
#define CRYPTOTALKCOIN_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending cryptotalkcoins */
...
#endif // CRYPTOTALKCOIN_QT_SENDCOINSDIALOG_H
