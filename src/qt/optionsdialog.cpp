    ...
    mapper(nullptr)
{
    ...
    ui->cryptotalkcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->cryptotalkcoinAtStartup);
    ...
    ui->cryptotalkcoinAtStartup->setToolTip(ui->cryptotalkcoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->cryptotalkcoinAtStartup->setText(ui->cryptotalkcoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openCryptotalkcoinConfButton->setToolTip(ui->openCryptotalkcoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new CryptotalkcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->cryptotalkcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openCryptotalkcoinConfButton_clicked()
{
    ...
    if (!GUIUtil::openCryptotalkcoinConf())
