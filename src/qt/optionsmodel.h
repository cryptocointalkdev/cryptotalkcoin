...
#ifndef CRYPTOTALKCOIN_QT_OPTIONSMODEL_H
#define CRYPTOTALKCOIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Cryptotalkcoin client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,             // QString
        ProxyPortTor,           // int
        DisplayUnit,            // CryptotalkcoinUnits::Unit
