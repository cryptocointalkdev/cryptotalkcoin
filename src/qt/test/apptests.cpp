...
//! Entry point for CryptotalkcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &CryptotalkcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for CryptotalkcoinGUI tests.
void AppTests::guiTests(CryptotalkcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &CryptotalkcoinGUI::consoleShown, this, &AppTests::consoleTests);
