...
#ifndef CRYPTOTALKCOIN_QT_WALLETVIEW_H
#define CRYPTOTALKCOIN_QT_WALLETVIEW_H
...
public:
    ...
    void setCryptotalkcoinGUI(CryptotalkcoinGUI *gui);
...
#endif // CRYPTOTALKCOIN_QT_WALLETVIEW_H
