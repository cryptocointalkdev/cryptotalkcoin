    ...
    platformStyle(_platformStyle)
{
    ...
    // normal cryptotalkcoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying cryptotalkcoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &CryptotalkcoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
