...
void WalletView::setCryptotalkcoinGUI(CryptotalkcoinGUI *gui)
{
    if (gui)
    {
        // Clicking on a transaction on the overview page simply sends you to transaction history page
        connect(overviewPage, &OverviewPage::transactionClicked, gui, &CryptotalkcoinGUI::gotoHistoryPage);

        // Navigate to transaction history page after send
        connect(sendCoinsPage, &SendCoinsDialog::coinsSent, gui, &CryptotalkcoinGUI::gotoHistoryPage);
        ...
        connect(this, &WalletView::encryptionStatusChanged, gui, &CryptotalkcoinGUI::updateWalletStatus);

        // Pass through transaction notifications
        connect(this, &WalletView::incomingTransaction, gui, &CryptotalkcoinGUI::incomingTransaction);

        connect(this, &WalletView::incomingMessage, gui, &CryptotalkcoinGUI::incomingMessage);

        // Connect HD enabled state signal
        connect(this, &WalletView::hdEnabledStatusChanged, gui, &CryptotalkcoinGUI::updateWalletStatus);
    }
}
