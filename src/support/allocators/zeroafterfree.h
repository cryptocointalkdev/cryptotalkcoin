...
#ifndef CRYPTOTALKCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define CRYPTOTALKCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // CRYPTOTALKCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
