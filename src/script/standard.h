...
#ifndef CRYPTOTALKCOIN_SCRIPT_STANDARD_H
#define CRYPTOTALKCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a cryptotalkcoin address
 */
...
/**
 * Generate a Cryptotalkcoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // CRYPTOTALKCOIN_SCRIPT_STANDARD_H
